<?php
 ...
 /*          if (eregi($regexp, $email)) return 1;
				...
				eregi has been depricated and doesn't work now.
*/		 		
          ...
          if (isset($_POST['submit']))
               {
                  echo "Hi ".$_POST['first_name']." ".$_POST['last_name']."!<br />";
    ...
    ?>
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>"subscribe.php" method="post">
              <p>
                  First Name:<br />
                 <input type="text" name="first_name" size="20" maxlength="40" value="" />
             </p>
